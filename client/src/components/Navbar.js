    ...
    <>
      <div className='pb-5 pt-10 px-20 relative z-10 hidden md:block'>
        <div className='flex justify-between items-center'>
          <div className='flex items-baseline justify-between w-fit gap-5'>
            ...
            <Link to="/files" className='text-text-light dark:text-text-dark opacity-80 hover:opacity-95 font-medium text-xl transition-opacity duration-150'>Rate Us</Link>
      ...
      <div className='pb-5 pt-5 relative z-[999] md:hidden block w-full'>
        <div className='flex justify-between items-center w-full'>
          ...
          <div className={`flex flex-col py-5 fixed border-b-2 border-[#b5b5b5] dark:border-[#ffffff4d] backdrop-blur-lg top-0 left-0 right-0 gap-3 w-full transition duration-500 transform ${isOpen ? 'translate-y-0' : '-translate-y-full'} items-center justify-between`}>
            ...
            <Link onClick={() => setIsOpen(!isOpen)} to="/files" className='text-text-light dark:text-text-dark opacity-80 hover:opacity-95 font-medium text-xl transition-opacity duration-150'>Rate Us</Link>
